...
export function ComplaintBooklet({ navigation }) {
  const handleSubmit = () => {
    navigation.navigate('StackAnonima');
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.divText}>
        ...
        <Text>
          Esse aplicativo tem como finalidade o cadastro de denuncia na
          Instituição Futuro Pré-Vestibular.
        </Text>
        <Text style={styles.text}>
          A seguir serão solicitadas sobre a denuncia.{' '}
        </Text>
        ...
        <Text style={styles.listItem}>
          &bull; Havendo necessidade o administrador entrará em contato pelo
          chat.
        </Text>
      </View>
